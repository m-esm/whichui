...
export const nextUiSupportedComponents: { [component: string]: number } = {
  Avatar: 1,
  Accordion: 1,
  Autocomplete: 1,
  Badge: 1,
...
export const radixUiSupportedComponents: { [component: string]: number } = {
  AlertDialog: 1,
  AspectRatio: 1,
  Avatar: 1,
  Badge: 1,
...
export const shadcnUiSupportedComponents: { [component: string]: number } = {
  Accordion: 1,
  Alert: 1,
  AlertDialog: 1,
  AspectRatio: 1,
...
export const materialUiSupportedComponents: { [component: string]: number } = {
  Alert: 1,
  AppBar: 1,
  Autocomplete: 1,
  Avatar: 1,
...
export const chakraUiSupportedComponents: { [component: string]: number } = {
  AspectRatio: 1,
  Box: 1,
  Center: 1,
  Container: 1,
...
export const antDesignSupportedComponents: { [component: string]: number } = {
  Button: 1,
  FloatButton: 1,
  Icon: 1,
  Typography: 1,
